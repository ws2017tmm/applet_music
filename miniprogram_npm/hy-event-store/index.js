...
__DEFINE__(1679208050158, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1679208050159,"./event-store":1679208050160}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679208050159, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1679208050160, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1679208050159,"./utils":1679208050161}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679208050161, function(require, module, exports) {
...
return __REQUIRE__(1679208050158);
})()
